...
```mermaid
graph TD
    A[Gözlem: Kurt Sürüsü] --> B{Biyotaklit Süreci}
    B --> C[Askeri Doktrin: Turan Taktiği]
    B --> D[Sosyal Yapı: Sürü Zekası]
    B --> E[Lojistik: Göçerlik/Devinim]
    
    C --> F[Sahte Geri Çekilme]
    C --> G[Kuşatma / Hilal]
    
    D --> H[Otonom Karar Alma]
    E --> I[Düşük Enerji / Yüksek Hareket]
```
